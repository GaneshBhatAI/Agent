"""
Gmail Email Sending Component for AIAnveshana Framework.
"""
...
def send_gmail(
    ...
    """
    Sends email via Gmail SMTP server (smtp.gmail.com:587).
    ...
    Parameters:
        ...
        username (str): Gmail account username/email (REQUIRED).
        password (str): Gmail App Password (REQUIRED).
